...
public class ControladorMerito {
    ...
    private void onEventosMaestros() {
        // Limpiar listener previo de NetBeans
        for (java.awt.event.ActionListener al : vistaPrincipalMaestros.btnAgregarMerito2.getActionListeners()) {
            vistaPrincipalMaestros.btnAgregarMerito2.removeActionListener(al);
        }
        // VistaPrincipalMaestros no tiene JDesktopPane, se muestra en JDialog
        vistaPrincipalMaestros.btnAgregarMerito2.addActionListener(e -> mostrarVistaComoDialogo());
