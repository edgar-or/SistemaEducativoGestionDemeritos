...
public class ControladorPrincipalMaestros {
    ...
    public void cargarGrados() {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(
                    vista,
                    "Error al cargar grados: " + e.getMessage()
            );
        }
    }
    ...
    public void cargarSecciones(int idGrado) {
        ...
        List<ModeloSeccion> secciones =
                seccionProfesorDAO.obtenerSeccionesPorGrado(idGrado);

        for (ModeloSeccion s : secciones) {
            vista.comboSeccion.addItem(s.getSeccion());
        }

        vista.comboSeccion.putClientProperty(
                "listaSecciones",
                secciones
        );
...
//    public ModeloAlumno(int nie, String nombre, String apelliddos, int idGrado, String duiEncargado, int totalPuntos, int idSeccion) {
            ...
            // BUSQUEDA NORMAL SQL
            String nombre =
                    vista.txtBuscarNombres.getText().trim();

            String apellido =
                    vista.txtBuscarApellido.getText().trim();
    ...
    public int getIdGradoSeleccionado() {
        ...
        List<ModeloGrado> lista =
                (List<ModeloGrado>) vista.comboGrado
                        .getClientProperty("listaGrados");
    ...
    private int getIdSeccionSeleccionada() {
        ...
        List<ModeloSeccion> lista =
                (List<ModeloSeccion>) vista.comboSeccion
                        .getClientProperty("listaSecciones");
    ...
    private void configurarEventos() {
        ...
        // BOTON BUSCAR
        vista.brnBuscar.addActionListener(
                e -> buscarAlumnos()
        );
        ...
        vista.btnAgregarDemerito.addActionListener(e -> {
            ...
            int filaSeleccionada =
                    vista.tablaEstidiantes.getSelectedRow();
            ...
            VistaAgregarDemerito vistaDemerito =
                    new VistaAgregarDemerito();

            new ControladorAgregarDemerito(
                    vistaDemerito,
                    nie,
                    nombreCompleto
            );
        ...
        vista.btnAgregarMerito.addActionListener(e -> {
            ...
            VistaAgregarMerito vistaMerito =
                    new VistaAgregarMerito();

            new ControladorAgregarMerito(
                    vistaMerito,
                    nie,
                    nombreCompleto
            );
